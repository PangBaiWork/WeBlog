...
import com.pangbai.terminal.TerminalEmulator;
import com.pangbai.terminal.TerminalRow;
import com.pangbai.terminal.TextStyle;
...
public final class TerminalRenderer {
  ...
  public  void setShadow(int color){
	...
	//	mTextPaint.setColor(Color.BLUE);
		//字体阴影
	//	mTextPaint.setShadowLayer(5,0,0,Color.WHITE);
            ...
            for (int column = 0; column < columns; ) {
                ...
                if (style != lastRunStyle || insideCursor != lastRunInsideCursor || insideSelection != lastRunInsideSelection || fontWidthMismatch || lastRunFontWidthMismatch) {
                    if (column == 0) {
                        ...
                        //颜色控制
						//if(Command.roll)
						cursorColor = lastRunInsideCursor ? mEmulator.mColors.mCurrentColors[TextStyle.COLOR_INDEX_CURSOR] : 0;
					    //else
