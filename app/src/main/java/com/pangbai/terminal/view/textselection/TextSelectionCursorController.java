package com.pangbai.terminal.view.textselection;
...
import com.pangbai.terminal.TerminalBuffer;
import com.pangbai.terminal.WcWidth;
import com.pangbai.terminal.view.TerminalView;
    ...
    public void setActionModeCallBacks() {
     callback = new ActionMode.Callback() {
            ...
            public boolean onCreateActionMode(ActionMode mode, Menu menu) {
                ...
                menu.add(Menu.NONE, ACTION_COPY, Menu.NONE,"复制").setShowAsAction(show);
                menu.add(Menu.NONE, ACTION_PASTE, Menu.NONE, "粘贴").setEnabled(clipboard.hasPrimaryClip()).setShowAsAction(show);
                menu.add(Menu.NONE, ACTION_MORE, Menu.NONE, "更多");
                return true;
            }
            ...
            public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
                ...
                switch (item.getItemId()) {
                     ...
                     //   Toast.makeText(main.instance, selectedText, Toast.LENGTH_SHORT).show();
